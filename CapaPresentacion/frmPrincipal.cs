...
namespace CapaPresentacion
{
    public partial class frmPrincipal : Form
    {
        ...
        private void arículosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //Para tambien llamar a la instancia que consta este formulario
        ...
        {
            //Aqui se controlan los tipos de usuarios.
