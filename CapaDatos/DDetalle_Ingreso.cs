    ...
    public class DDetalle_Ingreso
    {
        ...
        public string Insertar(DDetalle_Ingreso Detalle_Ingreso, ref SqlConnection SqlCon, ref SqlTransaction SqlTra)
        {
            ...
            try
            {
                ...
                ParIddtealle_Ingreso.ParameterName = "@iddetalle_ingreso";
                ParIddtealle_Ingreso.SqlDbType = SqlDbType.Int;
                ParIddtealle_Ingreso.Direction = ParameterDirection.Output;
